	...
	<div id="main_container">
		...
		<div id="main_content">
			...
			<div class="center_content">
				...
				<div class="prod_box">
					...
					<div class="center_prod_box">
						...
						<div class="product_img">
							<a href="details.html"><img src="resources/images/p2.jpg" alt=""
								title="" border="0" /></a>
						</div>
						<div class="prod_price">
							<span class="reduce">350$</span> <span class="price">270$</span>
				...
				<div class="prod_box">
					...
					<div class="center_prod_box">
						...
						<div class="product_img">
							<a href="details.html"><img src="resources/images/p4.jpg" alt=""
								title="" border="0" /></a>
						</div>
						<div class="prod_price">
							<span class="reduce">350$</span> <span class="price">270$</span>
				...
				<div class="prod_box">
					...
					<div class="center_prod_box">
						...
						<div class="product_img">
							<a href="details.html"><img src="resources/images/p3.jpg" alt=""
								title="" border="0" /></a>
						</div>
						<div class="prod_price">
							<span class="reduce">350$</span> <span class="price">270$</span>
				...
				<div class="prod_box">
					...
					<div class="center_prod_box">
						...
						<div class="product_img">
							<a href="details.html"><img src="resources/images/p5.jpg" alt=""
								title="" border="0" /></a>
						</div>
						<div class="prod_price">
							<span class="reduce">350$</span> <span class="price">270$</span>
				...
				<div class="prod_box">
					...
					<div class="center_prod_box">
						...
						<div class="product_img">
							<a href="details.html"><img src="resources/images/p6.jpg" alt=""
								title="" border="0" /></a>
						</div>
						<div class="prod_price">
							<span class="reduce">350$</span> <span class="price">270$</span>
				...
				<div class="prod_box">
					...
					<div class="center_prod_box">
						...
						<div class="product_img">
							<a href="details.html"><img src="resources/images/p7.jpg" alt=""
								title="" border="0" /></a>
						</div>
						<div class="prod_price">
							<span class="reduce">350$</span> <span class="price">270$</span>
			...
			<div class="right_content">
				...
				<div class="border_box">
					<input type="text" name="newsletter" class="newsletter_input"
						value="keyword" /> <a href="#" class="join">search</a>
				</div>
				...
				<div class="banner_adds">
					...
					<a href="#"><img src="resources/images/bann1.jpg" alt="" title=""
						border="0" /></a>
				</div>
		...
		<div class="footer">
			...
			<div class="left_footer">
				<img src="resources/images/footer_logo.png" alt="" title="" width="89"
					height="42" />
			</div>
			...
			<div class="center_footer">
				Template name. All Rights Reserved 2008<br /> <a
					...
					title="free css templates"><img src="resources/images/csscreme.jpg"
					alt="free css templates" border="0" /></a><br /> <img
					src="resources/images/payment.gif" alt="" title="" />
			</div>
