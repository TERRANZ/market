...
<!-- 			<input type="text" name="name" class="newsletter_input" hint="что ищем?" /> <input type="submit" value="Поиск"> -->
<!-- 		</form> -->
<!-- 	</div> -->
	...
	<div class="border_box">
		...
		<div class="product_img">
			<a href="details.html"><img src="resources/images/p2.jpg" alt="" title="" border="0" /></a>
		</div>
	...
	<div class="banner_adds">
		...
		<a href="#"><img src="resources/images/bann1.jpg" alt="" title="" border="0" /></a>
	</div>
...
<div class="footer">
	...
	<div class="left_footer">
		<img src="resources/images/footer_logo.png" alt="" title="" width="89" height="42" />
	</div>
