...
<tr>
	<td valign="middle" width="220"><a href="/market/market"><img src="resources/images/companyname.gif" border="0" alt="Радиоэлектротовары"></a></td>
	...
	<td valign="middle" align="right"
		...
		class="lightsmall" href="javascript:document.lang_form.new_language.value=0;document.lang_form.submit();">Русский</a> <font class="lightsmall">/</font>
		<a class="lightsmall" href="javascript:document.lang_form.new_language.value=1;document.lang_form.submit();">English</a>
		...
		<table cellspacing=0 cellpadding=1 border=0>
			...
			<form action="/market/search" method=get>
				...
				<tr>
					<td><input type="text" name="searchstring" size="15" style="color: #3E578F;" value="Поиск"
