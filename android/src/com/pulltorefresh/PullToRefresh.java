...
public class PullToRefresh extends LinearLayout
{
	...
	{
		return canPullDownToRefresh && state != REFRESHING && isIncremental() && isFirstVisible() && adapter != null
	...
	private class PullToRefreshAdapter extends BaseAdapter
	{
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			if ((position == 0 && offset == 1) || adapter == null)
			{
				if (convertView == null)
				{
					convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.pull_to_refresh_header, null);
					convertView.findViewById(R.id.pull_to_refresh_image).setVisibility(View.GONE);
					convertView.findViewById(R.id.pull_to_refresh_progress).setVisibility(View.VISIBLE);
					TextView tv = (TextView) convertView.findViewById(R.id.pull_to_refresh_text);
